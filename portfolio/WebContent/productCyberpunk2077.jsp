...
<meta charset="UTF-8">
<title>productCyberpunk2077</title>
</head>
<style>
...
for (int i=0; i<1; i++) {   // 리스트를 출력할때 for문을 써서 출력하는데 반복문의 경우 데이터를 전부 가져오는 문제가 발생 -> for문을 if문으로 바꾸는 것이 아니라 반복을 중지 시킨다. 
...
<div>
© 2021, Beyond Games, Inc. All Rights Reserved. Beyond, Beyond Games, Beyond Games 로고, Fortknight, Fortknight 로고, The Unreal Games, The Unreal Games Engine, The Unreal Games Engine 로고, The Unreal Games Tournament, The Unreal Games Tournament 로고의 모든 저작권은 Beyond Games, Inc.에 있으며, 이는 미국 및 그 외 국가에 모두 해당됩니다. 기타 브랜드 또는 제품 이름은 해당 소유자의 상표입니다. 미국 외 거래는 Beyond Games International, S.à r.l.을 통해 이뤄집니다.  
